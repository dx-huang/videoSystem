                ...
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home"
                           role="tab"
                           aria-controls="nav-home" aria-selected="true">课程目录</a>
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <c:forEach items="${courseVideoList}" var="video" varStatus="idx">
                            <a href="/topicVideo/${video.courseTopicId}/${video.id}" class="list-group-item list-group-item-action list-group-item-light border-0">
                                <i class="fa fa-play-circle-o">&nbsp;&nbsp;第${idx.index + 1}讲
                                    <span class="ml-3">${video.videoName}</span>
                                    <c:choose>
...
<%--                    </div>--%>
        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4"><img src="/static/imgs/456.jpg" class="rounded-circle"
                                                   alt="Responsive image" style="height: 60px;width: 60px;">
                        </div>
                        <div class="col-md-8">黄老师<br><span class="text-secondary"
                                                           style="font-size: 16px;">Java区</span>
                        </div>


                        <span class="text-secondary mt-2" style="font-size: 14px;">粉丝交流群：123456789</span>
