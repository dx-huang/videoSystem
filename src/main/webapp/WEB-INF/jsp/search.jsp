    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            <li class="page-item ${topicList.hasPreviousPage? "" :"disabled"} ">
                <a class="page-link" href="/search?pageNum=${topicList.prePage}&keyword=${keyword}">上一页</a>
            </li>
            <%--            //导航条上的第一页--%>
            ...
            <li class="page-item ${topicList.hasNextPage? "" :"disabled"} ">
                <a class="page-link" href="/search?pageNum=${topicList.nextPage}&keyword=${keyword}">下一页</a>
            </li>
        </ul>
    </nav>
</div>
